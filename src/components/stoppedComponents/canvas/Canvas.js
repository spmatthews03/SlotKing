              ...
              <View style={{flex:1, paddingVertical:10, paddingHorizontal:10}}>
                <View style={{flex:1}}>
                  ...
                  <View style={{flex:1, flexDirection:'row',}}>
                    ...
                    <View style={{flex:1}}>
                      <CardHolder src={this.props.cards[10]} num="10" state={this.props.gameState} wait={1000}/>
                    </View>
                    <View style={{flex:1}}>
                      <CardHolder src={this.props.cards[11]} num="11" state={this.props.gameState} wait={1100}/>
                    </View>
                    <View style={{flex:1}}>
                      <CardHolder src={this.props.cards[12]} num="12" state={this.props.gameState} wait={1200}/>
                    </View>
                  </View>
                  <View style={{flex:1, flexDirection:'row',}}>
                    <View style={{flex:1}}>
                      <CardHolder src={this.props.cards[13]} num="13" state={this.props.gameState} wait={1300}/>
                    </View>
                    <View style={{flex:1}}>
                      <CardHolder src={this.props.cards[14]} num="14" state={this.props.gameState} wait={1400}/>
                    </View>
                    <View style={{flex:1}}>
                      <CardHolder src={this.props.cards[15]} num="15" state={this.props.gameState} wait={1500}/>
                    </View>
                    <View style={{flex:1}}>
                      <CardHolder src={this.props.cards[16]} num="16" state={this.props.gameState} wait={1600}/>
                    </View>
                  </View>
                </View>
              </View>
